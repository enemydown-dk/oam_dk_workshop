...
URL = 'https://api.unpaywall.org/' #URL til API'et
MAIL = 'random@email.dk' #angiv din e-mail her, påkrævet for at undgå blacklist.
FILE_NAME = 'doiliste.csv' #angiv filnavn på den fil der indeholder din DOI-liste.
